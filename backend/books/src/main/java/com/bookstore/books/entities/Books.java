...
public class Books {
	...
	@NotBlank(message="Author is not provided")
	...
	public Books(int book_id, @NotBlank(message = "Title is not provided") String title,
			@NotBlank(message = "Author is not provided") String author, String description,
			@NotNull(message = "Price is not provided") int price, int total_reviews, String image_url,
			String out_of_stock, List<ReviewDto> reviews, int average_reviews) {
		super();
