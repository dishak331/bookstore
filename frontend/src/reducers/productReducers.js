...
export const productReviewsReducer = (state = { reviews: reviews }, action) => {
  switch (action.type) {
    ...
    case PRODUCT_CREATE_REVIEW_SUCCESS:
      ...
      // const review = { ...state.reviews, id: [...state.reviews[id], action.payload.newReview] };
      reviews[id] = [...reviews[id], action.payload.newReview];
